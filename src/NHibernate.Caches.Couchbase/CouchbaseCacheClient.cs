...
{
	public class CouchbaseCacheClient : ICache
	{
		...
		static CouchbaseCacheClient()
		{
			log = LoggerProvider.LoggerFor(typeof (CouchbaseCacheClient));
		}
		...
		public CouchbaseCacheClient(string regionName)
			: this(regionName, null)
		{
		}

		public CouchbaseCacheClient(string regionName, IDictionary<string, string> properties)
			: this(regionName, properties, new CouchbaseClient())
		{
		}

		public CouchbaseCacheClient(string regionName, IDictionary<string, string> properties, CouchbaseClient couchbaseClient)
		{
			region = regionName;
